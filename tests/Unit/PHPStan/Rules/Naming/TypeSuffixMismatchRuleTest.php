...
final class TypeSuffixMismatchRuleTest extends RuleTestCase
{
    ...
    private const string VALID_MULTI_LEVEL_SELECTABLE_CHANNEL_INTERFACE_FILE                    = self::FIXTURES_DIR . '/Valid/EdgeCases/MultiLevelChannelHierarchy/SelectableChannelInterface.php';
    private const string VALID_MULTI_LEVEL_SWOW_SELECTABLE_CHANNEL_INTERFACE_FILE               = self::FIXTURES_DIR . '/Valid/EdgeCases/MultiLevelChannelHierarchy/SwowSelectableChannelInterface.php';
    private const string VALID_MULTI_LEVEL_SWOW_CHANNEL_FILE                                    = self::FIXTURES_DIR . '/Valid/EdgeCases/MultiLevelChannelHierarchy/SwowChannel.php';
     ...
     * @throws Throwable
     */
    public function testInlineVarGenericConcreteMultiLevelInterfaceHierarchySucceeds(): void
    {
        $this->skipCoverageUnstableTemplateBoundFixture();
        $this->analyse([
            self::VALID_MULTI_LEVEL_CHANNEL_INTERFACE_FILE,
            self::VALID_MULTI_LEVEL_SELECTABLE_CHANNEL_INTERFACE_FILE,
            self::VALID_MULTI_LEVEL_SWOW_SELECTABLE_CHANNEL_INTERFACE_FILE,
            self::VALID_MULTI_LEVEL_SWOW_CHANNEL_FILE,
            self::VALID_INLINE_VAR_GENERIC_CONCRETE_MULTI_LEVEL_INTERFACE_HIERARCHY_FILE,
        ], []);
    }
